...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  /*! exports provided: API_URL, API_URL_USERS, API_URL_ROLES */
  ...
  function srcAppConfigTs(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_require__.d(__webpack_exports__, "API_URL_USERS", function () {
      return API_URL_USERS;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "API_URL_ROLES", function () {
      return API_URL_ROLES;
    });

    var API_URL = 'http://localhost:44304/';
    var API_URL_USERS = 'http://localhost:44304/users';
    var API_URL_ROLES = 'http://localhost:44304/roles';
    /***/
  },
      ...
      _createClass(UserUpdateComponent, [{
        ...
        value: function ngOnInit() {
          ...
          if (this.currentUserId == "0") {
            this.store.dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_5__["UserPageActions"].initializeCurrentUser());
            this.currentUser$ = this.store.select(_store__WEBPACK_IMPORTED_MODULE_4__["getUser"]);
          } else {
            this.store.dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_5__["UserPageActions"].getCurrentUser({
              currentUserId: this.currentUserId
            }));
            this.currentUser$ = this.store.select(_store__WEBPACK_IMPORTED_MODULE_4__["getUser"]);
          }

          this.store.dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_5__["UserPageActions"].loadRoles());
          this.roles$ = this.store.select(_store__WEBPACK_IMPORTED_MODULE_4__["getRoles"]);
          this.errorMessage$ = this.store.select(_store__WEBPACK_IMPORTED_MODULE_4__["getError"]);
        }
      }]);
  ...
  function srcAppComponentsUsersUserModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _store_user_reducer__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ../../store/user.reducer */
    ...
    var _store_user_effects__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! ../../store/user.effects */
    ...
    UserModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_shared_shared_module__WEBPACK_IMPORTED_MODULE_10__["SharedModule"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"].forRoot(userRoutes), _ngrx_store__WEBPACK_IMPORTED_MODULE_6__["StoreModule"].forFeature('users', _store_user_reducer__WEBPACK_IMPORTED_MODULE_7__["userReducer"]), _ngrx_effects__WEBPACK_IMPORTED_MODULE_8__["EffectsModule"].forFeature([_store_user_effects__WEBPACK_IMPORTED_MODULE_9__["UserEffects"]])],
  ...
  function srcAppComponentsUsersUserListWrapperUserListWrapperComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      _createClass(UserListWrapper, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          this.store.dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_4__["UserPageActions"].loadUsers());
          this.users$ = this.store.select(_store__WEBPACK_IMPORTED_MODULE_3__["getUsers"]);
          this.store.dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_4__["UserPageActions"].loadRoles());
          this.roles$ = this.store.select(_store__WEBPACK_IMPORTED_MODULE_3__["getRoles"]);
          this.errorMessage$ = this.store.select(_store__WEBPACK_IMPORTED_MODULE_3__["getError"]);
        }
      }, {
        key: "searchUsers",
        value: function searchUsers(searchCriteriaInput) {
          this.store.dispatch(_store_actions__WEBPACK_IMPORTED_MODULE_4__["UserPageActions"].searchUsers({
    ...
    var UserService = /*#__PURE__*/function () {
      ...
      _createClass(UserService, [{
        ...
        value: function getUsers() {
          return this.http.get(_Config__WEBPACK_IMPORTED_MODULE_5__["API_URL_USERS"]).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (data) {
            return data;
        ...
        value: function getUser(currentUserId) {
          return this.http.get(_Config__WEBPACK_IMPORTED_MODULE_5__["API_URL_USERS"] + "/" + currentUserId).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (data) {
            return data;
          }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
        }
      }, {
        ...
        value: function searchUsers(searchCriteria) {
          ...
          return this.http.post(_Config__WEBPACK_IMPORTED_MODULE_5__["API_URL_USERS"] + "/GetUsersBySeacrhCriterias", searchCriteria, {
            headers: headers
        ...
        value: function getRoles() {
          return this.http.get(_Config__WEBPACK_IMPORTED_MODULE_5__["API_URL_ROLES"]).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (data) {
            return data;
        ...
        value: function createUser(user) {
          ...
          return this.http.post(_Config__WEBPACK_IMPORTED_MODULE_5__["API_URL_USERS"], newUser, {
            headers: headers
          }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (data) {
        ...
        value: function deleteUser(id) {
          ...
          var url = "".concat(_Config__WEBPACK_IMPORTED_MODULE_5__["API_URL_USERS"], "/").concat(id);
        ...
        value: function updateUser(user) {
          ...
          var url = "".concat(_Config__WEBPACK_IMPORTED_MODULE_5__["API_URL_USERS"], "/").concat(user.Id);
  ...
  function srcAppStoreActionsIndexTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*! ./user-page.actions */
    "./src/app/store/actions/user-page.actions.ts");
    ...
    /*! ./user-api.actions */
    "./src/app/store/actions/user-api.actions.ts");
    /* harmony reexport (module object) */
  ...
  /***/
  function srcAppStoreActionsUserApiActionsTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppStoreActionsUserPageActionsTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppStoreIndexTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _ngrx_store__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
    /*! @ngrx/store */
    "./node_modules/@ngrx/store/__ivy_ngcc__/fesm2015/store.js"); //import { UserState } from './user.reducer';
  ...
  /***/
  function srcAppStoreUserEffectsTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppStoreUserReducerTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    /*! @ngrx/store */
    "./node_modules/@ngrx/store/__ivy_ngcc__/fesm2015/store.js"); // export interface UserState {
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\angular_interview\NESS\downloadedGit\Angular_NGRX_CRUD_WEBAPI\angularNgRxCrud\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
